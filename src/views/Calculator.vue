<template>
<!-- <h1 class="mt-8 flex justify-center text-white text-2xl">Calculator</h1> -->
  ...
  <div class="grid grid-cols-4">
    <div class="grid-rows" v-for="n in calculatorElements" :key="n">
      <div class="lead text-white text-center m-1 py-3 bg-vue-dark rounded hover-class"
      :class="{'bg-vue-green': ['C', '*', '/', '-', '+', '%', '='].includes(n), 'size0': [0].includes(n), 'sizeOfEqual': ['='].includes(n)}"
      @click="action(n)"
    >
